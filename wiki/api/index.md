...
| 模块 | 描述 | 文档 |
|------|------|------|
| [认证模块](./auth.md) | 用户注册、登录、令牌管理 | auth.md |
| [市场模块](./market.md) | 资源搜索、发布、下载 | market.md |
| [支付模块](./payment.md) | 订单、钱包、提现 | payment.md |
| [论坛模块](./forum.md) | 帖子、回复、互动 | forum.md |
| [生成器模块](./generator.md) | 项目脚手架生成 | generator.md |
| [审核模块](./review.md) | 内容审核、举报处理 | review.md |
